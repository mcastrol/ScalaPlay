...
val clean_sizes =
  (rip: Raw_Import_Purchases) => {
    //use getInitNumeric if should start with numeric
...
val t3 = Raw_Import_Purchases("00001025305-5637655019", "000020181729","Waxed Black15in","",1,"2019-10-15","")
...
//good size
val t4 = Raw_Import_Purchases("00001025305-5637655019", "000020181729","8","fs60",1,"2019-10-15","")
